...
class Collisions(object):
    ...
    def resolve(self):
        ...
        def apply_impulse(collision_table_row):
            '''
            Apply impulse to colling objects
            '''

            o_1 = collision_table_row['o_1']
            o_2 = collision_table_row['o_2']
            velocity_difference = collision_table_row['o_1_effective_velocity'] - collision_table_row['o_2_effective_velocity']
